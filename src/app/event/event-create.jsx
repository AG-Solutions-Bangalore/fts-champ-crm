...
const EventCreate = () => {
  ...
  // Event type options with corresponding event_for options
  const eventTypeOptions = [
    { value: 'meeting', label: 'Meeting', eventForOptions: [
      { value: 'executive_committee', label: 'Executive Committee' },
      { value: 'youth_committee', label: 'Youth Committee' },
      { value: 'management_committee', label: 'Management Committee' }
    ]},
    { value: 'public_event', label: 'Public Event', eventForOptions: [
  ...
  // Fetch existing events (optional, if needed for validation)
  ...
  const createMutation = useMutation({
    mutationFn: (data) => {
      ...
      return axios.post('https://agstest.in/api2/public/api/event', formDataToSend, {
        headers: { 
    ...
    onSuccess: (response) => {
      if (response.data.code === 201 || response.status === 201) {
        ...
        navigate('/events'); // Adjust this route based on your application
  ...
  const handleEventTypeChange = (value) => {
    ...
    handleInputChange('event_for', ''); // Reset event_for when event_type changes
    
    // Set event_for options based on selected event_type
  ...
  const handleSubmit = (e) => {
    ...
    const submitData = {
      ...formData,
      // If your API expects specific date format, adjust here
        ...
        <Card className="p-4">
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {/* Event For Dropdown (depends on Event Type) */}
              <div className="">
