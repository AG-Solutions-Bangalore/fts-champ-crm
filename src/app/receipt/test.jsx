...
//       if (key !== 'individual_company' && key !== 'receipt_ref_no' && key !== 'receipt_date') {
...
//                     <span className="text-sm text-gray-600 truncate">{receipt.individual_company.indicomp_email}</span>
//                   </div>
//                 )}
//                 {pan && (
//                   <div className="flex items-center gap-2">
...
//           </div>
//           <div className="bg-gray-100 px-3 py-1 rounded">
//             Exemption Type: {receipt.receipt_exemption_type}
//           </div>
//         </div>

//         {/* Amount Warning */}
//         {receipt.receipt_total_amount > 2000 && receipt.receipt_exemption_type === "80G" && pan === "NA" && (
