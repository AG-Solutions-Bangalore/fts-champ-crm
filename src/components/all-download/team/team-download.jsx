...
const TeamDownload = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ row }) => <div className="text-xs font-medium">{row.getValue('Committee Type')}</div>,
      size: 120,
    },
    {
    ...
    },
    {
      ...
      id: 'Start Date',
      header: 'Start Date',
      cell: ({ row }) => <div className="text-xs font-medium">{row.getValue('Start Date')}</div>,
      size: 100,
    },
    {
      ...
      id: 'End Date',
      header: 'End Date',
      cell: ({ row }) => <div className="text-xs font-medium">{row.getValue('End Date')}</div>,
      size: 100,
    },
  ];
        ...
        <div className="p-4">
          <form className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-5 gap-3">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="committee_end_date" className="text-sm">To Date *</Label>
                <Input 
