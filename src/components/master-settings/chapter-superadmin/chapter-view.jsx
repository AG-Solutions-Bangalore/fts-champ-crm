  ...
  return (
    <div className="max-w-full space-y-2">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-end gap-3 pt-4">
                ...
                <Button 
                  ...
                  className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 h-8 text-xs"
                >
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="">
       ...
       <UserListSuperadmin id={id} users={users} isLoading={isLoading} isError={isError} refetch={refetch} isFetching={isFetching} ImageUrl={ImageUrl}/>
