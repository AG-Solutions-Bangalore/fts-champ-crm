import {
  CHAPTER_EDIT_STATES_DROPDOWN,
  fetchChapterEditById,
  fetchChapterUpdateEditById,
} from "@/api";
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("chapter_name", e.target.value)
                    }
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("chapter_city", e.target.value)
                    }
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleContactChange("chapter_pin", e.target.value)
                    }
                ...
                <div className="space-y-1">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleInputChange("chapter_state", value)
                    }
                    required
                  >
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("chapter_region_code", e.target.value)
                    }
        ...
        <Card className="p-4">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="">
            ...
            <TabsContent value="datasources" className="">
              <DatasourceListSuperadmin
                datasources={dataSource}
                id={id}
                chapterCodeForCreateDataSource={chapterCodeForCreateUser}
              />
            </TabsContent>
          </Tabs>
        </Card>
