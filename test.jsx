      ...
      {!receiptData && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-xl p-8 bg-white/80 backdrop-blur-xl border border-primary/20 rounded-3xl shadow-2xl"
          >
            {/* Header */}
            <motion.header
            ...
            >
              <div className="relative w-full">
                <Input
                  ...
                  className={`peer w-full  text-base rounded-xl border focus:ring-2 transition-all ${
                    searchFocused
              ...
              <Button
                ...
                className={`min-w-[120px] h-[45px] rounded-xl flex items-center justify-center gap-2 font-semibold text-white transition-all duration-200 ${
                  loadingrecepit
            ...
            >
              ...
              click <span className="text-primary font-medium">Search</span> to
              continue
            </motion.p>
            ...
            >
              {[
                ...
                { icon: Search, label: "Find Donors" },
                { icon: RefreshCcw, label: "Quick Update" },
              ].map(({ icon: Icon, label }, i) => (
                <motion.div
                  key={i}
                  whileHover={{ y: -4, scale: 1.03 }}
                  className="flex flex-col items-center justify-center gap-2 bg-gradient-to-b from-white to-primary/10 text-primary rounded-2xl py-4 px-3 shadow-sm hover:shadow-md transition-all"
                >
